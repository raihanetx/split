document.getElementById('currentYear').textContent = new Date().getFullYear();
        ...
        function startGuaranteedSkeletonDisplay() {
            ...
            const bannerImageContainer = homePage.querySelector('.banner-image-container');
        ...
        function showGuaranteedSkeletonForHomepage() {
            const gridsToSkeletonize = [
                document.getElementById('featuredCoursesGrid'), document.getElementById('popularSubscriptionsGrid'),
                document.getElementById('topSoftwareGrid'), document.getElementById('latestEbooksGrid')
            ];
        ...
        function displayActualContent() {
            ...
            const bannerImg = homePage.querySelector('.banner-image-container img.image-fade-in');
            if (bannerImg) {
...
// ⬇️ Add new product object below this line, inside the array ⬇️
        ...
        function setupEventListeners() {
            ...
            if (domElements.pageContainer) {
                domElements.pageContainer.addEventListener('submit', (event) => {
        ...
        async function loadPage(pageName) {
            ...
            if (pageName === 'productDetail') fileName = 'product-detail';
            else if (pageName === 'orderConfirmation') fileName = 'order-confirmation';
            ...
            try {
                ...
                pageContainer.innerHTML = `<p style="text-align:center; padding: 2rem; color: #777;">Error loading page content. Please try again later.</p>`;
            }
        }

        async function navigateToWithoutHistory(pageName, context = null, searchTerm = null) {
            window.scrollTo(0, 0);
            closeOffCanvasMenu();
        ...
        async function navigateTo(pageName, context = null, searchTerm = null, triggeredByUIAction = false) {
            ...
            if (pageName === 'checkout' && cart.length === 0 && !triggeredByUIAction) {
                ...
                await navigateToWithoutHistory(redirectPage, redirectContext);
            ...
            if (pageName === 'product' && context) {
                 ...
                 if(product) {
                    await navigateToWithoutHistory(pageName, context, searchTerm);
                 } else {
